...
/*
Problem Statement: Write a program for Morris preorder Traversal of a Binary Tree.
...
Output: preorder Traversal of this binary tree will be:- 4,2,5,6,1,3
...
class MorrisPreorderTraversal {
    public List<Integer> preorderTraversal(SdeSheetBinaryTree.TreeNode root) {
        List<Integer> preorder = new ArrayList<Integer>();

        SdeSheetBinaryTree.TreeNode cur = root;
        while(cur != null) {
            if(cur.left == null) {
