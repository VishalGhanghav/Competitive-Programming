...
public class BinaryTreeFromInAndPreorder {
    ...
    public static void main(String[] args) {
        BinaryTreeFromInAndPreorder binaryTreeFromInAndPreorder=new BinaryTreeFromInAndPreorder();
        int[] inorder={9,3,15,20,7};
        int[] preorder={3,9,20,15,7};
        TreeNode root=binaryTreeFromInAndPreorder.buildTree(preorder,inorder);
